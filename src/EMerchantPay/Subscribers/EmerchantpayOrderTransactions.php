 ...
 */
class EmerchantpayOrderTransactions implements SubscriberInterface
{
    /**
     * @var string
     */
    ...
    public function onOrderPostDispatch(\Enlight_Event_EventArgs $args)
    {
        ...
        if ($request->getActionName() == 'index') {
            $view->extendsTemplate('backend/emerchantpay_transactions/app.js');
        }

        if ($request->getActionName() == 'load') {
            $view->extendsTemplate('backend/emerchantpay_transactions/view/detail/window.js');
        }
    }
}
